...
同样的方法也可以用于配置前海端。先在香港端添加前海端的转发端点，然后将安装文件复制到前海端使用。

### 转发链配置

如果已经配置了前海端的转发端点，可以通过阿里云实现多级转发。在添加端口转发时，选择**转发链模式**即可：

<img src="https://img.coderluny.com:444/uploads/59b06546-e0cd-44e0-a7d6-ed075aef09d1.png" width="600" alt="转发链模式配置">
